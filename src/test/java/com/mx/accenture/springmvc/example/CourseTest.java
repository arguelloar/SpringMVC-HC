...
public class CourseTest {
    ...
    @MockBean
    private CourseService iCursoService; // This will mock a Spring Bean and Inject it where is needed
    ...
    void deleteCourseByIdTest() throws Exception{
        MvcResult result =mockMvc.perform(MockMvcRequestBuilders.delete("/course/delete/1"))
